...
service_list = ["dataset","server","client1", "client2", "client3", "client4", "client5", "client6", "client7", "client8"]
...
ax.plot(x_Axis, rules[6], label="client5", color="coral", marker='o')
ax.plot(x_Axis, rules[7], label="client6", color="gold", marker='o')
ax.plot(x_Axis, rules[8], label="client7", color="c", marker='o')
ax.plot(x_Axis, rules[9], label="client8", color="salmon", marker='o')
