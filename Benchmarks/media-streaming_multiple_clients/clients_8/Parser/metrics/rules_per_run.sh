...
python plot_rules_total.py ${parser_output_path}/rules_${service_list[0]} ${parser_output_path}/rules_${service_list[1]} ${parser_output_path}/rules_${service_list[2]} ${parser_output_path}/rules_${service_list[3]} ${parser_output_path}/rules_${service_list[4]} ${parser_output_path}/rules_${service_list[5]} ${parser_output_path}/rules_${service_list[2]} ${parser_output_path}/rules_${service_list[3]} ${parser_output_path}/rules_${service_list[4]} ${parser_output_path}/rules_${service_list[5]} $num_runs
