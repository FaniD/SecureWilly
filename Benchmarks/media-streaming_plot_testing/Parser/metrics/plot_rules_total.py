...
ax.legend(loc='center left', bbox_to_anchor=(1, 0), mode="expand", fancybox=True, shadow=True)
#ax.legend(loc=0)
#ax.grid()
ax.set_xlabel("Runs")
...
ax.legend(loc='lower right', bbox_to_anchor=(1, 0), mode="expand", fancybox=True, shadow=True, ncol=2)
