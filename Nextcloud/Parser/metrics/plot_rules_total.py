...
ax.plot(x_Axis, rules[0], label="db", color="blue", marker='o')
ax.plot(x_Axis, rules[1], label="nextcloud", color="magenta", marker='o')
...
#ax3.grid()
ax2.set_xlabel("Runs")
ax1.set_ylabel(r"Db rules")
ax2.set_ylabel(r"Nextcloud rules")
