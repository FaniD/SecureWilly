...
sudo rm -r /root/SecureWilly/Nextcloud/newtest/data
sudo mkdir /root/SecureWilly/Nextcloud/newtest/data
sudo chown www-data:www-data /root/SecureWilly/Nextcloud/newtest/data
...
sudo touch /root/SecureWilly/Nextcloud/newtest/data/willy/files/HelloFromTheOtherSide
