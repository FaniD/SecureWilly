...
However, as it is something \say{new} added to docker, there are some problems with the lack of filesystem support.
...
Except from adding capabilities one by one with flag --cap-add, Docker provides us with a feature called privileged, which, among others, adds all the linux capabilities that Docker supports. 
...
\begin{figure}[h!]
  \centering
   \includegraphics[width=0.6\linewidth]{omittmpfsgm.png}
...
\begin{figure}[h!]
  \centering
   \includegraphics[width=0.85\linewidth]{dockergroupgm.png}
