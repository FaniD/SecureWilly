...
\begin{itemize}
\item Static analysis extracting more rules
...
If we combine policy namespaces and policy stacking then we have an interesting result. Let's examine the figure below:
