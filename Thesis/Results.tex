...
Another way to test the functionality of SecureWilly is monitor the rules of each profile and identify which types of rules are encountered in it.

Figures 5.11, 5.12 and 5.13 show the line graphs of the types of different rules used in the media streaming services' profiles. 

\begin{textblock*}{18cm}(0.1cm,7.8cm) % {block width} (coords)
\begin{figure}
  \begin{minipage}[H!]{0.55\textwidth}
    \includegraphics[width=\textwidth]{./figures/mediastreaming/Barfinal_cloudsuitedata-cachingserver.png}
    \caption{Media Streaming: Server's types of rules}
  \end{minipage}
  \begin{minipage}[H!]{0.55\textwidth}
    \includegraphics[width=\textwidth]{./figures/mediastreaming/Barfinal_cloudsuitedata-cachingclient.png}
    \caption{Media Streaming: Client's types of rules}
  \end{minipage}
\end{figure}
\end{textblock*}
...
\begin{figure}[h!]
  \centering
   \includegraphics[width=0.65\linewidth]{./figures/mediastreaming/types_cloudsuitemedia-streamingdataset.png}
   \caption{Media Streaming: Dataset's types of rules}
\end{figure}
