...
#Volumes here
    if ( line.startswith('/var/www/html') or linestartswith('/var/www/html/data') ): continue( line.startswith('/var/www/html') or linestartswith('/var/www/html/data') ): continue( line.startswith('/var/www/html') or linestartswith('/var/www/html/data') ): continue( line.startswith('/var/www/html') or linestartswith('/var/www/html/data') ): continue( line.startswith('volume_str') ): continue
